        ...
        <div className="h-screen w-screen overflow-hidden bg-background">
          <ResizablePanelGroup direction="horizontal" className="h-full">
            ...
            <ResizablePanel defaultSize={65}>
              <div className="h-full flex flex-col bg-card">
                {/* Top Bar */}
                <div className="h-14 border-b border-border px-6 flex items-center justify-between bg-muted/30">
                  <Tabs
                    value={activeView}
                    onValueChange={(v) =>
                  ...
                  >
                    <TabsList className="bg-background border border-border p-0.5 h-9 shadow-sm">
